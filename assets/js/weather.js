    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        function temp_trans(input) {
          var temp =
            "Temperature: " +
            ((input.main.temp - 273.15) * 1.8 + 32).toFixed(2) +
            " F ";
          return temp;
        }
        ...
        $(".currentCity")
          .html(
            "<h3>" + response.city.name + " " + date_format(holder) + "</h3>"
          )
          .append(
            $(
              '<img src=" ' +
          ...
          $("#" + i + "dayIcon")
            ...
            .append(
              $(
                '<img src=" ' +
                  "http://openweathermap.org/img/wn/" +
                  holder.weather[0].icon +
                  ".png" +
                  ' "/>'
              )
            );
          $("#" + i + "dayHumidity").text(
            "Humidity: " + holder.main.humidity + " %"
          );
